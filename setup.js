// GRID_SIZE amount of columns used in game
...
// Lookup array for classes - CLASS_LIST only used when drawing grid
...
// array that represents the grid number corresponds to above CLASS_LIST[i]
export const LEVEL = [
